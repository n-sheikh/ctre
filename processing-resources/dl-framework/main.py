...
run_config_path = f'{base_dir}/cnc-task-3/runs/{config_dir}/run_config.txt'
data_config_path = f'{base_dir}/cnc-task-3/runs/{config_dir}/data_config.txt'
preprocessing_config_path = f'{base_dir}/cnc-task-3/runs/{config_dir}/preprocessing_config.txt'
